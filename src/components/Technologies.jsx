...
export const Projects = () => {
  ...
  return (
    <div className="relative">
      <div className="absolute top-0 z-[-2] min-h-screen w-screen bg-white bg-[radial-gradient(100%_50%_at_50%_0%,rgba(0,163,255,0.13)_0,rgba(0,163,255,0)_50%,rgba(0,163,255,0)_100%)]"></div>
          ...
          <AnimatePresence>
            {selectedProject && (
              <>
                ...
                >
                  <motion.div
                    className="relative bg-white/95 backdrop-blur-md rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-gray-100"
                    layoutId={`card-${selectedProject.id}`}
                    initial={{
                      x: origin.x - (window.innerWidth - origin.width) / 2,
                      y: origin.y,
                      width: origin.width,
